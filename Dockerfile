...
LABEL org.opencontainers.image.title="semrel-plugin-provider-git" \
      org.opencontainers.image.description="semrel plugin: provider-git" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/provider-git" \
